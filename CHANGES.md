...
## 1.2.0
 ...
 - Added Q.firstResolved(promisesArray) method.
   Returns a promise fulfilled with the value of the first resolved promise in
   promisesArray. If all promises in promisesArray are rejected, the returned
   promise is rejected with an array with the reasons of all rejected promises.
