...
describe("unhandled rejection reporting", function () {
    ...
    it("doesn't report a resolve, then reject (gh-252)", function () {
        ...
        expect(Q.getUnhandledReasons().length).is(0);
    });

    it("doesn't report when you chain off a rejection", function (done) {
        Q.reject("this will be handled")
        .get("property")
        .catch(function () {
    ...
    it("reports the most basic case", function () {
        ...
        expect(Q.getUnhandledReasons()).equals(["(no stack) a reason"]);
    });
    ...
    it("reports a stack trace", function () {
        ...
        expect(Q.getUnhandledReasons()).equals([error.stack]);
    });
    ...
    it("resets after calling `Q.resetUnhandledRejections`", function () {
        ...
        Q.resetUnhandledRejections();
        expect(Q.getUnhandledReasons()).equals([]);
    });
