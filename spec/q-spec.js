...
describe("defer and then", function () {
    ...
    it("then before reject", function () {
        var turn = 0;
        var deferred = Q.defer();
        var promise = deferred.promise.then(function () {
            expect(true).toBe(false);
...
describe("promises for objects", function () {
    ...
    describe("post", function () {
        ...
        it("fulfills a promise", function () {
            ...
            return Q(subject).post("a", [1]).then(function (two) {
    ...
    describe("send", function () {
        ...
        it("fulfills a promise", function () {
            ...
            return Q(subject).invoke("bar", 1, 2)
            .then(function (two) {
...
describe("all", function () {
    ...
    it("calls thenables lazilly", function () {
        var promise = Q({then: function () {
            expect(true).toBe(false);
        }})
        return Q.delay(10);
...
describe("node support", function () {
    ...
    describe("nfapply", function () {
        ...
        it("fulfills with callback result", function () {
            return NQ.nfapply(function (a, b, c, callback) {
                callback(null, a + b + c);
            }, [1, 2, 3])
            .then(function (sum) {
                expect(sum).toEqual(6);
    ...
    describe("nfcall", function () {
        it("fulfills with callback result", function () {
            return NQ.nfcall(function (a, b, c, callback) {
                callback(null, a + b + c);
            }, 1, 2, 3)
            .then(function (sum) {
                expect(sum).toEqual(6);
    ...
    describe("nfbind", function () {
        ...
        it("mixes partial application with complete application", function () {
            return NQ.nfbind(function (a, b, c, d, callback) {
    ...
    describe("nbind", function () {
        ...
        it("second arg binds this", function() {
            ...
            return NQ.nbind(function(callback) {
                callback(null, this);
            }, expectedThis).call()
    ...
    describe("ninvoke", function () {
        ...
        it("fulfills with callback result", function () {
            return NQ.ninvoke(obj, "method", 1, 2, 3)
            .then(function (sum) {
                expect(sum).toEqual(6);
            });
        });
        ...
        it("gets the correct thisp", function () {
            return NQ.ninvoke(obj, "thispChecker")
            .then(function (result) {
                expect(result).toBe(true);
            });
        });
        ...
        it("rejects with callback error", function () {
            return NQ.ninvoke(obj, "errorCallbacker", 1, 2, 3)
            .then(function () {
                expect("blue").toBe("no, yellow!");
            }, function (_exception) {
                expect(_exception).toBe(exception);
        ...
        it("rejects with thrown error", function () {
            return NQ.ninvoke(obj, "errorThrower", 1, 2, 3)
            .then(function () {
                expect(true).toBe(false);
            }, function (_exception) {
                expect(_exception).toBe(exception);
...
describe("possible regressions", function () {
    ...
    describe("gh-9", function () {
        it("treats falsy values as resolved values without error", function () {
            expect(Q(null).isPending()).toEqual(false);
            expect(Q(void 0).isPending()).toEqual(false);
            expect(Q(false).isPending()).toEqual(false);
    ...
    describe("gh-75", function () {
        it("does not double-resolve misbehaved promises", function () {
            ...
            return badPromise.then(onResolution, onResolution).then(function () {
...
describe("unhandled rejection reporting", function () {
    ...
    it("doesn't report when you chain off a rejection", function () {
        return Q.reject("this will be handled")
        .get("property")
        .catch(function () {
